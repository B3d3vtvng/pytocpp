    static Value vsub(const Value& val_1_v, const Value& val_2_v, const int line, const char* func){
        ...
        if (std::holds_alternative<long long>(val_1) && std::holds_alternative<long long>(val_2)) {
            ...
            RunTime instance;
            instance.throw_rt_error("Invalid type for operation: 'sub': " + get_dbg_type(val_1) + " - " + get_dbg_type(val_2), line, func);
            return Value(none{});
        }
    }
