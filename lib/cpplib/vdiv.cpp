    static Value vdiv(const Value& val_1, const Value& val_2, const int line, const char* func){
        if (val_1.is<long long>() && val_2.is<long long>()) {
            ...
            RunTime instance;
            instance.throw_rt_error("Invalid type for operation: 'div': " + get_dbg_type(val_1.value) + " / " + get_dbg_type(val_2.value), line, func);
            return Value(none{});
        }
    }
